...
// Returns the customer supplied name for the port number or an empty string if no name has been configured (for multi-port Airconsole devices that have more than one physical serial port). portNumber is in the range 1..portCount
